...
const variants = {
  base: "relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer h-[50px] w-[50px] md:h-[150px] md:w-[150px] border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out",
  image:
    "border-0 p-0 h-[50px] w-[50px]  sm:h-[80px] sm:w-[80px] md:h-[150px] md:w-[150px]  relative shadow-md bg-slate-200 dark:bg-slate-900 rounded-md",
  active: "border-2",
  disabled:
      ...
      <div className="w-full">
        <div className="flex items-center gap-4 justify-center">
          ...
          {value?.map(({ file, progress }, index) => (
            <div
              key={index}
              className={variants.image + " aspect-square h-[150px] w-[150xp]"}
            >
              <Image
                width={150}
                height={150}
          ...
          {(!value || value.length < (dropzoneOptions?.maxFiles ?? 0)) && (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400 hidden md:block">drag & drop to upload</div>
